...
# pd2[["data"]]
# unique(pd2$data$title)

# something is wrong here. Still have many plots for each district instead of just one. 
# also need to set condition for geom_point colors: point colors should match subtitle colors 
...
# files <- str_replace_all(tolower(final_plots$plots), " ", "_")
# paths <- here::here("plots", "final_plots", glue("{files}.png"))
# paths
