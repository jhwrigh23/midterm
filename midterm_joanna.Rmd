...
# cleaning up sub_by_district_year to make a table to answer question 1: acheivement gap effect size for each district in each academic year: 

sub_by_district_year_results %>%
  select(1, 2, 5:7)
